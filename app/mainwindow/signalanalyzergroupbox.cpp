    ...
    DisplaySizeDependingGroupBox(parent, new QHBoxLayout, toFlag(MODE_IDLE) | toFlag(MODE_RECORDING) | toFlag(MODE_TUNING))
{
    ...
    mKeyLabel->setFixedWidth(mKeyLabel->fontMetrics().tightBoundingRect("A#0").width());
    ...
    mFrequencyLabel->setFixedWidth(mFrequencyLabel->fontMetrics().tightBoundingRect("0000.0").width());
